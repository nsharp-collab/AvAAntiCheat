...
This software is licensed under the **Apache License, Version 2.0** (the "License"). You can find the full text of the License in the accompanying `LICENSE.txt` file.
